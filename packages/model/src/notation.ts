...
export type TeamShape =
  | "rounded-rect-horizontal"
  | "rounded-rect-vertical"
  | "octagon"
  | "rect";
...
export const TEAM_TYPE_SPECS: Record<TeamType, TeamTypeSpec> = {
  "stream-aligned": {
    ...
    description:
      "Aligned to a single, valuable stream of work; owns it end-to-end.",
...
export const ALL_TEAM_SPECS: readonly TeamTypeSpec[] =
  Object.values(TEAM_TYPE_SPECS);
export const ALL_INTERACTION_SPECS: readonly InteractionModeSpec[] = Object.values(
